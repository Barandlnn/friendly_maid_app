...
import 'package:friendly_maid_app/features/menu/other_products_personal_care_screen.dart';
        ...
        child: FittedBox(
          ...
          child: SizedBox(
            ...
            child: Stack(
              children: [
                Image.asset(
                  'assets/other_products_empty_full.png',
                  width: designWidth,
                  height: designHeight,
                  fit: BoxFit.fill,
                ),
                  ...
                  child: _Clickable(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              const OtherProductsPersonalCareScreen(),
                        ),
                      );
                    },
                    child: const SizedBox.expand(),
