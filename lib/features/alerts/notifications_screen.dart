...
import 'package:friendly_maid_app/features/alerts/expiry_alert_detail_screen.dart';
...
class NotificationsScreen extends StatelessWidget {
  ...
  static const Color cardGrey = Color.fromRGBO(239, 241, 245, 1);
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      width: 343,
                      height: 454,
                      child: _NotificationListAsset(
                        onExpiryLearnMoreTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => const ExpiryAlertDetailScreen(),
                            ),
                          );
                        },
                      ),
          ...
          Center(
            child: Text(
              ...
              style: GoogleFonts.montserrat(
                fontSize: 16,
                fontWeight: FontWeight.w700,
                color: NotificationsScreen.darkText,
              ),
            ),
          ),
        ],
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: const BoxDecoration(
        color: Colors.white,
        border: Border(
          top: BorderSide(color: NotificationsScreen.borderGrey, width: 1),
        ),
      ),
      child: Row(
        children: [
...
class _NavItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = active
        ? NotificationsScreen.green
        : NotificationsScreen.navGrey;
...
class _NotificationListAsset extends StatelessWidget {
  const _NotificationListAsset({required this.onExpiryLearnMoreTap});

  final VoidCallback onExpiryLearnMoreTap;
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        Image.asset(
          'assets/notifications_list.png',
          width: 343,
          height: 454,
          fit: BoxFit.fill,
        ),

        // Yesterday / Expiry Alert / Learn More alanı
        Positioned(
          left: 56,
          top: 211,
          width: 120,
